@testset "Geo interface" begin
    ...
    @test GeoInterphase.geotype(pt) == :Point
    ...
    @test GeoInterphase.geotype(polygon) == :Polygon
    ...
    @test GeoInterphase.geotype(multipolygon) == :MultiPolygon
    ...
    @test GeoInterphase.geotype(geomcollection) == :GeometryCollection
    ...
    for (i,item) in enumerate(collection)
        ...
        @test GeoInterphase.geotype(item) == geotypes[i]
    end
    @test GeoInterphase.geotype(geomcollection) == :GeometryCollection
